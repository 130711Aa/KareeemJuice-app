...
function CustomerNavbar() {
    ...
    return (
        <header className="flex items-center justify-between whitespace-nowrap border-b border-[#ff8c00]/10 px-4 md:px-8 py-3 bg-white/90 backdrop-blur-md sticky top-0 z-40">
            <Link to="/" className="flex items-center gap-3 text-[#181510]">
                ...
                <div>
                    <h1 className="text-lg font-bold leading-none tracking-tight">Kareeem Juice</h1>
...
function AdminNavbar() {
    ...
    const navLinks = [
        ...
        { to: '/admin/orders', label: 'Pesanan', badge: pendingCount },
        { to: '/admin/history', label: 'Riwayat' },
        { to: '/admin/menu', label: 'Kelola Menu' },
        { to: '/admin/categories', label: 'Kategori' },
        { to: '/admin/inventory', label: 'Stok Bahan' },
    ...
    return (
        <header className="flex flex-col border-b border-[#ff8c00]/10 bg-white sticky top-0 z-40">
            <div className="flex items-center justify-between px-4 md:px-10 py-3 whitespace-nowrap bg-white relative z-50">
                <Link to="/admin" className="flex items-center gap-3 text-[#181510]">
